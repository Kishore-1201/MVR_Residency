...
const Register: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0a192f] overflow-hidden font-sans">
      {/* Background image matching login */}
      <img
      ...
      {/* Enhanced card with additional hover effects */}
      <div className="relative z-20 w-full max-w-md p-10 rounded-3xl shadow-2xl bg-white/10 border border-indigo-600/30 backdrop-blur-lg animate-fade-in hover:shadow-indigo-500/30 hover:border-indigo-500/50 transition-all duration-300">
        <div className="flex flex-col items-center mb-8">
          <div className="transition-transform duration-300 hover:scale-110 hover:rotate-3 mb-2 group">
            <UserPlus className="h-16 w-16 text-indigo-600 drop-shadow-lg group-hover:text-indigo-400 transition-colors" />
          </div>
          <h1 className="text-4xl font-extrabold text-white drop-shadow mb-1 tracking-wide hover:text-indigo-300 transition-colors">
            Create Account
          </h1>
          <p className="text-center text-base text-white font-medium mb-2 max-w-xs hover:text-indigo-200 transition-colors">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-semibold text-white mb-1 hover:text-indigo-300 transition-colors">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-semibold text-white mb-1 hover:text-indigo-300 transition-colors">
                Email address
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-semibold text-white mb-1 hover:text-indigo-300 transition-colors">
                Password
              </label>
              <input
                id="password"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-semibold text-white mb-1 hover:text-indigo-300 transition-colors">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
