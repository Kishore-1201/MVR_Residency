...
const Login: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0a192f] overflow-hidden font-sans">
      {/* Modern luxury hotel background with blur */}
      <img
      ...
      <div className="relative z-20 w-full max-w-md p-10 rounded-3xl shadow-2xl bg-white/10 border border-indigo-600/30 backdrop-blur-lg animate-fade-in">
        <div className="flex flex-col items-center mb-8">
          <div className="transition-transform duration-300 hover:scale-110 hover:rotate-3 mb-2">
            <Hotel className="h-16 w-16 text-indigo-600 drop-shadow-lg" />
          </div>
          <h1 className="text-4xl font-extrabold text-white drop-shadow mb-1 tracking-wide">Welcome Back</h1>
          {/* <h2 className="text-2xl font-bold mb-2 tracking-wide text-indigo-600">MVR Residency</h2> */}
